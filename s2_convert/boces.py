...
print ("COMMAND,FIRSTNAME,LASTNAME,CREDENTIALS,ACCESSLEVELS,PersonID")
...
for row in rows:
    ...
    if printStr == 1:
        print strCommand + strFirstName + strLastName + strCredentials + ",{Staff~~~FALSE}," + str(strPersionID)
